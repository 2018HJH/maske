...
preinstall_l2tp(){
    ...
    read -p "(Default Range: 192.168.88):" iprange
    [ -z ${iprange} ] && iprange="192.168.88"

    echo "Please enter PSK:"
    read -p "(Default PSK: l2tp.com):" mypsk
    [ -z ${mypsk} ] && mypsk="l2tp.com"

    echo "Please enter Username:"
    read -p "(Default Username: l2tp):" username
    [ -z ${username} ] && username="l2tp"
    ...
    echo "Client Remote IP Range:${iprange}.1-${iprange}.253"
    echo "PSK:${mypsk}"
    echo
...
[lns default]
ip range = ${iprange}.1-${iprange}.253
...
EOF
    ...
    echo
    echo "Welcome to visit our internet"
    echo "Enjoy it!"
    echo
}
